...
# Glossary of terms with network
...
* No self loop can be showned - This is significant in this case, as self loop can be indicative of considerable amoung of illicit relationship/money movement within a country.
...
## Graphing individual clusters from the full Network
...
## Other methods of plotting network that works
...
network<- plot_ly(data=L, type='scatter',x=~X1, y=~X2, 
                  color=~centrality, size=~degree, mode="markers", text=~text, marker=list(colorscale='Viridis'), hoverinfo="text")
